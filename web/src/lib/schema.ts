...
export const EstimateRow = z
  .object({
    ...
    mu: z.number().gt(50).lt(800),
    sigma: z.number().gt(5).lt(150).optional(),
...
export const CountryRecord = z
  .object({
    ...
    sigma_source: z.enum(["source", "assumed_15", "assumed_100"]).nullable(),
...
export const AtlasManifest = z
  .object({
    ...
    threshold_iq: z.number().positive(),
    default_sigma: z.number().positive(),
